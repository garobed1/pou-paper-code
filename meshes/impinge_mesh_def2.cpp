/*   Program impinge_mesh_def2.cpp    */
/*
Create 

compilation:

g++ impinge_mesh_def2.cpp -L $CGNS_HOME/lib -lcgns -I $CGNS_HOME/include -o impinge_mesh_def2
...
/* define families */
   ier = cg_family_write(index_file,index_base,"wall",&index_fam_1);
