...
modelK.train()
errkrms = rmse(modelK, trueFunc, N=Nerr, xdata=xtest, fdata=ftest)
errkmean = meane(modelK, trueFunc, N=Nerr, xdata=xtest, fdata=ftest)
...
plt.savefig("arctan_2d_aniso_err_rms_ensemble.png")
...
plt.savefig("arctan_2d_aniso_err_mean_ensemble.png")
