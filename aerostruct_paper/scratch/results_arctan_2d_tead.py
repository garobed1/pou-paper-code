...
RC0 = TEAD(model0, gtrain0, xlimits, improve=pperb, neval=neval, ncand=ncand) #looCV(gek, approx=False)
...
plt.savefig("arctan_2d_err_tead.png")
...
plt.savefig("arctan_2d_pts_tead.png")
...
plt.savefig("arctan_2d_errcona_tead.png")
...
plt.savefig("arctan_2d_errconk_tead.png")
...
plt.savefig("arctan_2d_errcon0_tead.png")
